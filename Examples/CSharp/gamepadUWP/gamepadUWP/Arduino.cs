...
namespace LattePanda.Firmata
{
    ...
    class Arduino
    {
        ...
        public Arduino(string serialPortName, Int32 baudRate, bool autoStart, int delay, bool autoListen = true)
        {
            ...
            var deviceSelector = SerialDevice.GetDeviceSelector(serialPortName);
        ...
        {
            var vs = new string[10]; // SerialPort.GetPortNames();
            return vs;
        }
        /// <summary>
        ...
        {
            return 0;//_serialPort.BytesToRead;
        }
        ...
        /// </summary>
        private async void GetPort(string serialPortName)
        {
            try
            {
    ...
    class InputProcessor
    {
        ...
        //                int inputData = 0;//_serialPort.ReadByte();
        //      int command;
